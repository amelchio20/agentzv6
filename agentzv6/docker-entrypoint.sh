...
# 30.11.21, amelchio changed ZBX_SERVER_HOST from
# : ${ZBX_SERVER_HOST:="zabbix-server"}
# to : ${ZBX_SERVER_HOST:="100.64.15.164"}
# ZBX_SERVER_HOST, for zabbix agent this is the zabbix-proxy, definitions moved to values-feat, -prod
# , -dev.yaml under ......\zabbix-app\helm\zabbix-agent
# : ${ZBX_SERVER_HOST:="100.64.15.164"}

# Default Zabbix server port number
: ${ZBX_SERVER_PORT:="10051"}

# 30.11.21, amelchio added Default Linux Zabbix Agent Metadata needed for agent registration
# : ${ZBX_METADATA:="LINUX"}
# moved the global definition of ZBX_METADATA to ..\zabbix-app\helm\zabbix-agent\values.yaml
